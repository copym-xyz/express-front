...
const InvestorLogin = () => {
  ...
  const handleGoogleLogin = () => {
    // Redirect to Google OAuth with investor role hint
    window.location.href = 'http://localhost:5000/api/auth/google?rolehint=investor';
  };

  const handleTwitterLogin = () => {
    // Redirect to Twitter OAuth with investor role hint
    window.location.href = 'http://localhost:5000/api/auth/twitter?rolehint=investor';
  };
      ...
      <div className="max-w-md w-full space-y-8 bg-gray-800 p-8 rounded-lg">
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-400">
            ...
            <Link to="/investor/register" className="font-medium text-cyan-400 hover:text-cyan-300">
              Sign up
            </Link>
          </p>
        </div>
